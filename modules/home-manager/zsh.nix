...
in
{
  options.custom.zsh.enable = lib.mkEnableOption "Enable Zsh module";

  config = {
    programs.starship = lib.mkIf config.custom.zsh.enable {
      enable = true;
      enableZshIntegration = true;
    };

    programs.zsh = lib.mkIf config.custom.zsh.enable {
      enable = true;
